...
void creerEtat(const char* argv[], Etat& etat){
    ...
    string capture1 = string(string("../Images/") + etat.filename + string("_a_ori.bmp"));
    string capture2 = string(string("../Images/") + etat.filename + string("_b_ori.bmp"));
    string capture3 = string(string("../Images/") + etat.filename + string("_a_mod.bmp"));
    string capture4 = string(string("../Images/") + etat.filename + string("_b_mod.bmp"));
